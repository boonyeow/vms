        ...
        http
                ...
                .authorizeHttpRequests(
                        (requests)  -> requests
                                ...
                                .requestMatchers( "/api/workflows", "/api/workflows/**", "/api/form", "/api/forms/**", "/api/formsubmission", "/api/formsubmission/**", "/api/fields", "/api/fields/**").hasAuthority(AccountType.VENDOR.name())
